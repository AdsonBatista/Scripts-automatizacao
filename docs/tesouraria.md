  O projeto de automatização da tesouraria tem como intuito manter em um único local e de forma organizada, todos os dados de tesouraria para o Ramo Estudantil IEEE UFABC. 
